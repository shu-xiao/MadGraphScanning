...
hApathFix = 'BannerfileFix/run_*.txt'  
hApathDyn = '../diffPDF/Bannerfile263400/run_*.txt'  
...
def main():
	...
	histo_hA030 = TH2F('xsec1','Xsec(gz=0.8, tb=1.0) pdf setting 263000',17,500,4100,6,250,850)
        histo_hA034 = TH2F('xsec2','PDF = 263400, Cross-Section(pb) of fixed and dynamic option and #DeltaCS',17,500,4100,6,250,850)
