...
def getGzValue(readLine):
        GzValue = float(readLine.split(' # ')[0].split()[1])
        return GzValue
...
def main():
	...
	histo_hA0 = TH2F('xsec1','Xsec1 pdf setting 263000',9,0.3,3,6,0.3,1.5)
	histo_hA0.SetXTitle("Tb")
	histo_hA0.SetYTitle("gz")
	histo_hA0.SetStats(0)

	for a in hAList:
		histo_hA0.Fill(a.tanbeta,a.gz,a.weight)
	gStyle.SetPalette(1)
