...
def main():
	...
	hAList = gethAList(hA_files)
        ...
        #xAxis = array('d',[600.,800.,1000.,1200.,1400.,1700.,2000.,2500.,2750.,3000.,3500.,4000.])
	...
	histo_hA0 = TH2F('xsec1','Xsec(gz=0.8, tb=1.0) pdf setting 263000', len(xAxis)-1, xAxis, len(yAxis)-1, yAxis)
