...
do
    ...
    do
        ...
        sed -e 's/ZBFOLDER/'$newname'/g' -e 's/gqu/'$gq'/g' -e 's/MMED/'$mmed'/g' -e 's/MCHI/'$mchi'/g' -e 's/gZZH/'$gzzh'/g' ZpBaryonic_jj_proc_card.dat > ${procCardDir}/${newname}_proc_card.dat
